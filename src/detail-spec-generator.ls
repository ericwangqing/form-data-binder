...
if define? # AMD
  define 'detail-spec-generator', ['model-parser', 'descriptions-parser', 'appearance-parser'], detail-spec-generator 
else # other
  root = module?.exports ? @
  root.detail-spec-generator = detail-spec-generator model-parser, descriptions-parser, appearance-parser
