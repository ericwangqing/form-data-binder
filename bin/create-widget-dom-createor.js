(function(){
  var createWidgetDomCreateor, root, ref$, slice$ = [].slice;
  createWidgetDomCreateor = function(util){
    return {
      make: function(spec){
  ...
  if (typeof define != 'undefined' && define !== null) {
    define('create-widget-dom-createor', ['util'], createWidgetDomCreateor);
  } else {
    root = (ref$ = typeof module != 'undefined' && module !== null ? module.exports : void 8) != null ? ref$ : this;
    root.createWidgetDomCreateor = createWidgetDomCreateor();
  }
}).call(this);
