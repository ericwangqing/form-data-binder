(function(){
  var detailSpecGenerator, root, ref$;
  ...
  if (typeof define != 'undefined' && define !== null) {
    define('detail-spec-generator', ['model-parser', 'descriptions-parser', 'appearance-parser'], detailSpecGenerator);
  } else {
    root = (ref$ = typeof module != 'undefined' && module !== null ? module.exports : void 8) != null ? ref$ : this;
    root.detailSpecGenerator = detailSpecGenerator(modelParser, descriptionsParser, appearanceParser);
  }
}).call(this);
